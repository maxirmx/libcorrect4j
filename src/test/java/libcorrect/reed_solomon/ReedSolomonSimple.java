...
public class ReedSolomonSimple {
    ...
    void rsTestPassThrough() {
        ...
        ReedSolomon rs = new ReedSolomon(correctRsPrimitivePolynomial_8_7_6_1_0, (byte)1, (byte)1, minDistance);
    ...
    void rsTestPassWithCorrection() {
        byte[] msgIn = "abcdef".getBytes();
        ReedSolomon rs = new ReedSolomon(correctRsPrimitivePolynomial_8_7_2_1_0, (byte)1, (byte)1, minDistance);
        byte[] encoded =  rs.encode(msgIn);
